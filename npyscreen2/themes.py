...
import curses
from . import theme_managers as theme_managers

class DefaultTheme(theme_managers.ThemeManager):
    default_colors = {
        'DEFAULT'     : 'WHITE_BLACK',
...
class ElegantTheme(theme_managers.ThemeManager):
    default_colors = {
        'DEFAULT'     : 'WHITE_BLACK',
        'FORMDEFAULT' : 'WHITE_BLACK',
        'NO_EDIT'     : 'BLUE_BLACK',
...
class ColorfulTheme(theme_managers.ThemeManager):
    default_colors = {
        'DEFAULT'     : 'RED_BLACK',
...
class BlackOnWhiteTheme(theme_managers.ThemeManager):
    default_colors = {
        'DEFAULT'     : 'BLACK_WHITE',
...
class TransparentThemeDarkText(theme_managers.ThemeManager):
    _colors_to_define = (
